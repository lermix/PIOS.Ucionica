...
import { getClassrooms, GetExamResults, getExams, GetQuestions, getStudents, getSubject, GetTeachers } from '../Stores/Classroom/actions';
                                ...
                                <Routes>
                                    ...
                                    {userLogedIn && (
                                        <>
                                            ...
                                            <Route path="/ExamsResults" element={<ExamResults />} />
                                        </>
                                    )}
                                </Routes>
                            </DrawerContainer>{' '}
